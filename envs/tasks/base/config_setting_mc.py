...
class setting_config:
    ...
    datasets = 'minecraft'  # 带有 prompt 的数据，正式训练用
    # datasets = 'minecraft_min' # 少量带有 prompt 的数据，用于测试代码
    # datasets = 'minecraft_sp' # 不带 prompt 的数据，训练对于单个任务的网络

    

    
    if datasets == 'minecraft':
        data_path = './data/minecraft/'
        network = 'cmunet'
        model_config = {
            'num_classes': 1, 
            'input_channels': 3, 
    ...
    elif datasets == 'minecraft_min':
        data_path = './data/minecraft_min/'
        network = 'cmunet'
        model_config = {
            'num_classes': 1, 
            'input_channels': 3, 
    ...
    elif datasets == 'minecraft_sp':
        data_path = './data/minecraft_sp/'
        network = 'egeunet'
        model_config = {
            'num_classes': 1, 
            'input_channels': 3, 
    ...
    # model_checkpoint_path = 'results/egeunet_minecraft_sp_Thursday_21_March_2024_17h_46m_56s/checkpoints/'
    model_checkpoint_path = 'envs/tasks/base/unet_checkpoint'

    video_path = './videos/test_01.mp4'
    prompt = 'find a sheep'
